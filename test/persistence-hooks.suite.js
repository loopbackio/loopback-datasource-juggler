...
//    describe.skip('patchById', function() {
//      var instanceId;
//
//      beforeEach(function createTestData(done) {
...
//
//        existingInstance.name = 'changed';
//        TestModel.patchById(instanceId, { name: 'changed' }, function(err) {
//          if (err) return done(err);
//          ctxRecorder.records.should.eql(aCtxForModel(TestModel, {
//            isNewInstance: false,
//          }));
...
//        TestModel.observe('after save', ctxRecorder.recordAndNext());
//
//        TestModel.patchById(instanceId, { name: 'updated' }, function(err, instance) {
//          if (err) return done(err);
//          ctxRecorder.records.should.eql(aCtxForModel(TestModel, {
//            isNewInstance: false,
//          }));
