...
/**
 * Deep compares values of objects
...
/**
 * Whether an object is in a collection
 * @param  {Array} collection Haystack
 * @param  {Object} obj        Needle
 * @return {Boolean}            Whether objects is in collection
 */
function inCollection(collection, obj) {
  for (var i in collection) {
    if (isEqual(collection[i], obj)) {
      return true;
    }
  }
  return false;
