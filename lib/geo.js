  ...
  if (where && typeof where === 'object') {
    Object.keys(where).forEach(function (key) {
      ...
      if (ex && ex.near) {
        ...
        console.log('And or Or Geolocation');
        ex.forEach(function (condition){
          console.log(condition);
          Object.keys(condition).forEach(function(condKey){
            var condSubEx = condition[condKey];
            if(condSubEx.near){
              console.log(condSubEx);
              result = {
                near: condSubEx.near,
                maxDistance: condSubEx.maxDistance,
                unit: condSubEx.unit,
                key: condKey
              };
            }
