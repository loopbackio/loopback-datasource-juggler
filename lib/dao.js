    ...
    if (Object.keys(data).length != 0) {
      ...
      self.find(filter, function(err, instances) {
        ...
        if (modelsLength === 0 && data.hasOwnProperty(pk)) {
          ...
          cb('Error message: No matching instance found.Found error while trying to create a new instance.' +
            'Primary key' +
        ...
        } else cb('There are multiple instances found.Upsert Operation will not be performed');
      });
    } else cb('data field cannot be empty');
  }
};
/**
