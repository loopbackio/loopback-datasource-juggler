...
DataAccessObject.exists = function exists(id, options, cb) {
  ...
  if (id !== undefined && id !== null && id !== '') {
    ...
    process.nextTick(function() {
      cb(new Error(g.t('Model::exists requires the id argument')));
    });
  }
  return cb.promise;
};
...
DataAccessObject.findById = function findById(id, filter, options, cb) {
  ...
  if (isPKMissing(this, cb)) {
    ...
    process.nextTick(function() {
      cb(new Error(g.t('{{Model::findById}} requires the id argument')));
    });
  } else {
...
function DateType(arg) {
  var d = new Date(arg);
  if (isNaN(d.getTime())) {
    throw new Error(g.f('Invalid date: ' + arg));
  }
  return d;
}
...
DataAccessObject.deleteById = function deleteById(id, options, cb) {
  ...
  if (isPKMissing(this, cb)) {
    ...
    process.nextTick(function() {
      cb(new Error(g.t('{{Model::deleteById}} requires the id argument')));
    });
    return cb.promise;
  }
