 ...
 */
ModelBaseClass.afterInitialize = null;
...
ModelBaseClass.prototype._initProperties = function(data, options) {
  ...
  this.__trigger('initialize');
};

ModelBaseClass.prototype.__trigger = function trigger(actionName, work, data, callback) {
  var self = this;
  var inst = this.constructor;
  var capitalizedName = actionName.charAt(0).toUpperCase() + actionName.slice(1);
  var afterHook = inst['after' + capitalizedName] ||
    inst['post' + capitalizedName];
