...
var inCollection = require('./utils.js').inCollection;
 ...
 *
 * options object comes with `disableInherit` property ( default: `false`), when property is set to `true`
 * sub-models that extends this model will not inherit such validations.
 *
...
function configure(cls, validation, args, opts) {
  ...
  args.forEach(function(attr) {
    if (typeof attr === 'string') {
      ...
      if (!inCollection(cls.validations[attr], validation)) {
