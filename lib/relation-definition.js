...
RelationDefinition.prototype.applyScope = function(modelInstance, filter) {
  ...
  if ((this.type !== 'belongsTo' || this.type === 'hasOne') &&
    ...
    if (this.polymorphic.invert) {
      filter.where[discriminator] = this.polymorphic.discriminatorName || this.modelTo.modelName;
    } else {
      filter.where[discriminator] = this.polymorphic.discriminatorName || this.modelFrom.modelName;
    }
  }
  var scope;
...
RelationDefinition.prototype.applyProperties = function(modelInstance, obj) {
  ...
  if ((this.type !== 'belongsTo' || this.type === 'hasOne') &&
    ...
    var discriminator = this.polymorphic.discriminator;
    if (this.polymorphic.invert) {
      target[discriminator] = this.polymorphic.discriminatorName || this.modelTo.modelName;
    } else {
      target[discriminator] = this.polymorphic.discriminatorName || this.modelFrom.modelName;
    }
  }
};
